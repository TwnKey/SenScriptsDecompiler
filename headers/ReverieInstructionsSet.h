  ...
  public:
    ...
    std::shared_ptr<Instruction> create_instruction_from_xlsx(int& addr, int opcode) override {
        switch (opcode) {
            ...
            case 0x09:
                return std::make_shared<OPCode9>(addr, this);
            case 0x0A:
            ...
            case 0xD9:
                return std::make_shared<OPCodeD9>(addr, this);
            case 0xDA:
                return std::make_shared<OPCodeDA>(addr, this);
            case 0xDB:
                return std::make_shared<OPCodeDB>(addr, this);
            case 0xDC:
                return std::make_shared<OPCodeDC>(addr, this);
            case 0xDE:
                return std::make_shared<OPCodeDE>(addr, this);
            case 0xDF:
                return std::make_shared<OPCodeDF>(addr, this);
            case 0xE0:
                return std::make_shared<OPCodeE0>(addr, this);
            case 0xE1:
                return std::make_shared<OPCodeE1>(addr, this);
            case 0xE2:
                return std::make_shared<OPCodeE2>(addr, this);
            case 0xE3:
                return std::make_shared<OPCodeE3>(addr, this);
            case 0xE5:
                return std::make_shared<OPCodeE5>(addr, this);
            case 0xE6:
                return std::make_shared<OPCodeE6>(addr, this);
            case 256:
