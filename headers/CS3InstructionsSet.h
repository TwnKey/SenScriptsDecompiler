        ...
        while ((int)control_byte[0]!=1){
                ...
                switch ((unsigned char)control_byte[0])  {
                    ...
                    case 0x1c:{
                        ...
                        operande op = operande(addr,"bytearray", instr2->getBytes());
    ...
    class ActionTable : public Instruction
    {
        ...
        ActionTable(int &addr, QByteArray &content,Builder *Maker):Instruction(addr,"ActionTable", 258,Maker){
            ...
            do{
                ...
                /*QByteArray str3 = ReadStringSubByteArray(content, addr);
                this->AddOperande(operande(addr,"string", str3));
                QByteArray remaining3 = ReadSubByteArray(content, addr, 0x20-str3.size()-1);
                operande fill3 = operande(addr,"fill", remaining3);
                fill3.setBytesToFill(0x20);
                this->AddOperande(fill3);*/
...
>>>>>>> Stashed changes
    ...
    class OPCode33 : public Instruction //This one is actually SO LONNNG that I can't possibly analyze all the cases
